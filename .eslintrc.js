module.exports = {
  ...
  'plugins': ['eslint-plugin-import', 'eslint-plugin-jsdoc', 'eslint-plugin-prefer-arrow', '@typescript-eslint', 'eslint-plugin-prettier'],
  ...
  'rules': {
    ...
    'camelcase': ['error', {
      allow: ['mime_type', 'not_defined', 'error_message']
    }],
  ...
  'overrides': [{
    ...
    'files': ['test/unit/*.ts', 'src/lib/generate-report/helpers/generate-html.ts', 'src/lib/mongoose-report-manager/mongoose-queries.ts'],
    'excludedFiles': '*.*.ts',
    'rules': {
      'sort-keys': ['off']
    }
