...
A sample can be found [here](https://wswebcreation.github.io/projects/html-cucumber-report-generator/doc/index.html)
...
``` bash
npm install html-cucumber-report-generator
```

Save to dependencies or dev-dependencies:

``` bash
npm install html-cucumber-report-generator --save
npm install html-cucumber-report-generator --save-dev
```
...
```javascript
const report = require('html-cucumber-report-generator');
...
report.generate({
        mongoDb:{
          ...
          dbHost: 'localhost',
          dbName: 'test-multiple-cucumber-html-reports-generate-report',
          dbPort: 27017,
        },
        ...
        reportGenerationParameters:{
          ...
          projectName: 'You can adjust this report name',
...
## Options
  reportGenerationParameters: ReportGeneration;
  reportConfigurationParameters: ReportDisplay;
...
With this option it is possible to ooverride the style of the report.
...
### - reportGenerationParameters
  projectName?: string;
  date?: Date;
  featuresFolder?: string | undefined;
...
The absolute path of the folder that will hold all the generated JSON files, relative from where the script is started.
