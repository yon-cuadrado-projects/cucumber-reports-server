...
export const connectionRefused = 'error connecting to mongodb: Error: connect ECONNREFUSED 127.0.0.1:25';
export const connectionRefusedError = 'connect ECONNREFUSED 127.0.0.1:25';
